...
<html lang="en">
    ...
    <body>
        ...
        <main class="form-container" id="log">
            <h1>Login Page</h1>
            <p>To sign up, please go to the <a href="register.php">Sign In page</a>.</p>
            <form action="process_login.php" method="post" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="pwd" required maxlength="45" name="pwd" placeholder="Enter password" class="form-control">
                </div>        
