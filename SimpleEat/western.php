...
<html lang="en">
    ...
    <body>
        ...
        ?>  
            ...
            $stmt = $conn->prepare("SELECT * FROM world_of_food_recipes WHERE recipe_name = 'Scallop Pasta' OR  recipe_name ='Cheese Burger' AND email =?");
...
<main class="cuisine-container">
    ...
    <div class="row">
        ...
        <article class="col-sm">
            ...
            <div class="button">
                <a href="recipe_details_home.php#<?php echo $row["id"]; ?>" >View Recipe</a>
            </div>
            </div>
        </article>
