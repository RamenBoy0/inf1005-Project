...
<html lang="en">
    ...
    <body>
        ...
        <main class="container" id="add_recipe">
            ...
            $upload = $errorupload = "";
            $targetDir = "/var/www/html/SimpleEats/images/";
...
//            $email_query = "SELECT email FROM world_of_food_recipes WHERE email = '" . $email . "'";
...
//                $errorMsg = "Error, user email not found";
//                $success = false; 
//        }
//            else{
//              $stmt = $conn->prepare("INSERT INTO world_of_food_recipes (recipe_name, prep_time, cook_time, serving, description, ingredients, methods, photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
//               $stmt->bind_param("siiissss", $rname, $prep, $cook, $serving, $description, $ingredients, $methods, $upload);
